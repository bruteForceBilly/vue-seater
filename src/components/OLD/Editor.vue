  ...
  beforeDestroy() {
    ...
    window.removeEventListener("keydown", (e) => {
      if (e.key == "e") {
        ...
        console.log(
          "seatContainer cache bitmap: ",
          this.seatContainer.cacheAsBitmap
        );
      }
    });
  },
